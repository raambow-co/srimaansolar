  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={rooftopSolar}
          alt="Rooftop Solar Panels Telangana"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left space-y-6">
            ...
            >
              ...
              <span>Telangana's Leading Solar Partner</span>
            </motion.div>
            ...
            >
              Join 500+ families across Telangana reducing their electricity bills by up to 90% with modern on-grid, off-grid, and hybrid solar panel systems.
            </motion.p>
              ...
              >
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <span className="block text-sm font-extrabold text-slate-800">500+ Installed</span>
                  </div>
                </motion.div>
              </motion.div>
